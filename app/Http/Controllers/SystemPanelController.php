...
class SystemPanelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $system_panel->price = $request->input('system_panel_price');
    ...
    public function show(SystemPanel $systemPanel)
    {
        ...
        ->select('system_panels.id','system_panels.system_panel_name','system_panels.price','system_panels.package_id','packages.package_name')
